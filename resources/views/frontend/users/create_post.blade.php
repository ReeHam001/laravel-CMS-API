...
@section('content')
    ...
    <div class="col-lg-9 col-12">
        ...
        <div class="form-group my-2">
            ...
            <button type="button" class="btn btn-primary btn-xs my-2 mx-1" id="select_btn_tag">Select all</button>
            <button type="button" class="btn btn-primary btn-xs my-2 mx-1" id="deselect_btn_tag">Deselect all</button>
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            $('#select_btn_tag').click(function (){  // from pk select2
